...
define('libs/CardGridModelFactory',[
		'backbone',
		'underscore',
...
/* START_TEMPLATE */
define('hbs!tmpl/CardViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
...
function program1(depth0,data) {
  ...
  return "\n<section class=\"container1 matched ripple\">\n";}

function program3(depth0,data) {
  
  
  return "\n<section class=\"container1 ripple\">\n";}

  stack1 = depth0.matched;
  stack1 = helpers['if'].call(depth0, stack1, {hash:{},inverse:self.program(3, program3, data),fn:self.program(1, program1, data)});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n    <div class=\"card\">\n        <div class=\"front p\"> <span>?</span></div>\n        <div class=\"back p\">";
  foundHelper = helpers.info;
  if (foundHelper) { stack1 = foundHelper.call(depth0, {hash:{}}); }
  else { stack1 = depth0.info; stack1 = typeof stack1 === functionType ? stack1() : stack1; }
  buffer += escapeExpression(stack1) + "</div>\n    </div>\n</section>\n";
  return buffer;});
Handlebars.registerPartial('tmpl_CardViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;

define('views/CardView',[
    'jquery',
    'backbone',
...
/* START_TEMPLATE */
define('hbs!tmpl/GameControlsViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<nav class=\"navbar navbar-default\" role=\"\" style=\"max-width:500px;margin-left:auto;margin-right:auto\">\n  <div class=\"container-fluid\">\n    <!-- Brand and toggle get grouped for better mobile display -->\n    <div class=\"navbar-header\">\n      <button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbarContent\">\n        <span class=\"sr-only\">Toggle navigation</span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n        <span class=\"icon-bar\"></span>\n      </button>\n      <a class=\"navbar-brand\" href=\"#\">Flip&Match</a>\n    </div>\n\n    <!-- Collect the nav links, forms, and other content for toggling -->\n    <div class=\"collapse navbar-collapse\" id=\"navbarContent\">\n      <ul class=\"nav navbar-nav\">\n        <li><a id=\"newGameLink\" href=\"#\" data-target=\"#navbarContent\"><span class=\"glyphicon glyphicon-play\"></span>  New Game</a></li>\n      </ul>\n\n      <ul class=\"nav navbar-nav navbar-right\">\n        <li><a id=\"aboutLink\" href=\"#\" data-target=\"#navbarContent\">About</a></li>\n      </ul>\n    </div><!-- /.navbar-collapse -->\n\n  </div><!-- /.container-fluid -->\n</nav>\n";});
Handlebars.registerPartial('tmpl_GameControlsViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;

define('views/GameControlsView',[
		'backbone',
...
/* START_TEMPLATE */
define('hbs!tmpl/AboutViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<p class=\"lead text-center\">A <u>simple</u> and hopefully  <strong>fun</strong> memory game.</p>\n<p class=\"lead text-center\">Enjoy!</p>\n<p class=\"pull-right\">For any * get in contact through <a href=\"mailto:#\">ezequiel.ballesi@takepart.com.ar</a> </p>\n";});
Handlebars.registerPartial('tmpl_AboutViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;
...
/* START_TEMPLATE */
define('hbs!tmpl/NewGameViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<button data-gameType=\"numbers\" type=\"button\" class=\"btn btn-default\">Numbers</button>\n";});
Handlebars.registerPartial('tmpl_NewGameViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;
...
/* START_TEMPLATE */
define('hbs!tmpl/CloseCurrentGameViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<h4 class=\"text-center\">You will lose your game progress.</h4>\n<h4 class=\"text-center\">Do you want to continue?</h4>\n<button id=\"yesBtn\" type=\"button\" class=\"btn btn-default\">Yeah, f this game!</button>\n<button id=\"cancelBtn\" type=\"button\" class=\"btn btn-default pull-right\">Nope, please take me back sir</button>\n";});
Handlebars.registerPartial('tmpl_CloseCurrentGameViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;

define('views/CloseCurrentGameView',[
		'backbone',
...
/* START_TEMPLATE */
define('hbs!tmpl/GameWonViewTmpl',['hbs','handlebars'], function( hbs, Handlebars ){ 
var t = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  helpers = helpers || Handlebars.helpers;
  


  return "<p class=\"lead text-center text-uppercase\"><strong>You've won!!!</strong></p>\n<p class=\"lead text-center\">According to our stats your game play was the most accurate and brillant in this game history.*</p>\n<p class=\"pull-right\">* This sure is because no one but you played this game to the end... so...</p>\n<p class=\"lead text-center\"><strong>Cheers to you!!!</strong></p>\n";});
Handlebars.registerPartial('tmpl_GameWonViewTmpl', t);
return t;
});
/* END_TEMPLATE */
;

define('views/GameWonView',[
		'backbone',
